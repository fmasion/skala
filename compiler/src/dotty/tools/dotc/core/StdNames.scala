...
// Keywords, need to come first -----------------------
    ...
    final val ABSTRACTkw: N  = kw("implementationsdefiniert")
    final val CASEkw: N      = kw("muster")
    final val CLASSkw: N     = kw("klasse")
    final val CATCHkw: N     = kw("fang")
    final val DEFkw: N       = kw("verfahrensweise")
    final val DOkw: N        = kw("mach")
    final val ELSEkw: N      = kw("andernfalls")
    final val EXTENDSkw: N   = kw("erbt")
    final val FALSEkw: N     = kw("unrichtig")
    final val FINALkw: N     = kw("letzte")
    final val FINALLYkw: N   = kw("endlich")
    final val FORkw: N       = kw("für")
    final val FORSOMEkw: N   = kw("gegeben")
    final val IFkw: N        = kw("sofern")
    final val IMPLICITkw: N  = kw("stillschweigend")
    final val IMPORTkw: N    = kw("einführen")
    final val INLINEkw: N    = kw("auffaltungsanleitung")
    final val LAZYkw: N      = kw("faul")
    ...
    final val PRIVATEkw: N   = kw("vertraulich")
    final val PROTECTEDkw: N = kw("zugangsbeschränkt")
    final val RETURNkw: N    = kw("retoure")
    final val SEALEDkw: N    = kw("versiegelt")
    final val SUPERkw: N     = kw("vorgesetzte")
    final val THENkw: N      = kw("gegebenenfalls")
    final val THISkw: N      = kw("ich")
    final val THROWkw: N     = kw("wirf")
    final val TRAITkw: N     = kw("charakterzug")
    final val TRUEkw: N      = kw("wahrhaftig")
    final val TRYkw: N       = kw("versuche")
    final val TYPEkw: N      = kw("sorte")
    final val VALkw: N       = kw("unveränderliche")
    final val VARkw: N       = kw("opportunistisch")
    final val WITHkw: N      = kw("außerdem")
    final val WHILEkw: N     = kw("während")
    final val YIELDkw: N     = kw("vorfahrtGewähren")
...
// ----- Term names -----------------------------------------
 ...
 //   val conforms : N             = "conforms" // Dotty deviation: no special treatment of conforms, so the occurrence of the name here would cause to unintended implicit shadowing. Should find a less common name for it in Predef.
    ...
    val `macro` : N             = "kompilationsroutine"
